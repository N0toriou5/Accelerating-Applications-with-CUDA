...
int main(const int argc, const char** argv) {
  ...
  cudaGetDeviceProperties(&props, deviceId); // props has now many useful properties about active GPU
  ...
  //numberOfBlocks =  32 * computeCapabilityMajor;
  numberOfBlocks =  computeCapabilityMajor;
